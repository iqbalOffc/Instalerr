...
display_welcome() {
  ...
  echo -e ""
  echo -e "𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 :"
  echo -e "@6287793857430"
  echo -e "𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 :"
  echo -e "@iqbalofficial2"
  echo -e "𝗖𝗥𝗘𝗗𝗜𝗧𝗦 :"
  echo -e "@IqbalOfficial"
  sleep 4
  clear
}
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY IQBAL OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "iqbalofficial" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke IqbalOfficial${NC}"
    echo -e "${YELLOW}TELEGRAM : @iqbalofficial2${NC}"
    echo -e "${YELLOW}WHATSAPP : 6287793857430${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©Iqbal Official${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer BalzTzy   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : iqbalofficial2   ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : IQBALOFFC  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Zeroone  ${NC}"
  ...
  echo "4. Create Node"
  echo "5. HackBack Panel"
  echo "6. Install theme"
  echo "7. Uninstall theme"
  echo "8. Ubah Pw Vps"
  echo "9. Theme Stellar"
  echo "x. Exit"
